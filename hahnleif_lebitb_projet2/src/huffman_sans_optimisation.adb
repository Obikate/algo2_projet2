with Ada.Text_IO, Ada.Integer_Text_IO, Ada.Command_Line, Ada.Streams.Stream_IO, Arbre_Huffman_sans_optimisation;
use Ada.Text_IO, Ada.Integer_Text_IO, Ada.Command_Line, Ada.Streams.Stream_IO, Arbre_Huffman_sans_optimisation;

procedure Huffman_sans_optimisation is
...
--		Affiche_Arbre(Arbre_Huffman);
		...
		Close(Entree);
		Close(Sortie);
		--sortie pour l'affichage correct tu temps réel
		put("Temps d'exécution réel");
	end Compression;
